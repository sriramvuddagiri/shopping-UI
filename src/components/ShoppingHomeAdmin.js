...
function ShoppingHomeAdmin() {
  let navigate = useNavigate();
  
  async function tokenValidate(){
    const response = await axios({
      method: "get",
      url: "/app1/api/v1.0/Shopping/adminvalidate",
      headers: {
          ...
          <Navbar bg="light" expand="lg" className="mb-3 mb-sm-0">
            ...
            <Navbar.Collapse>
              <Nav className={styles.navContainer}>
                ...
                <Nav.Link>
                  <Link to="updateproducts" className="text-decoration-none">
                    <li className="list-group-item fs-5 py-3 text-primary shadow">
                      <span>
                        <RiRssFill /> Update Products
                      </span>
                    </li>
                  </Link>
                </Nav.Link>
                <Nav.Link>
                  <Link to="addproducts" className="text-decoration-none">
                    <li className="list-group-item fs-5 py-3 text-primary shadow">
                      <span>
                        <RiContactsBook2Fill /> Add Products
                      </span>
                    </li>
                  </Link>
                </Nav.Link>
                <Nav.Link>
                  <Link to="alladminproducts" className="text-decoration-none">
                    <li className="list-group-item fs-5 py-3 text-primary shadow">
                      <span>
                ...
                <Nav.Link>
                  <Link to="deleteproducts" className="text-decoration-none">
                    <li className="list-group-item fs-5 py-3 text-primary shadow">
                      <span>
                        <RiRssFill /> Delete Products
                      </span>
                    </li>
                  </Link>
                </Nav.Link>
...
export default ShoppingHomeAdmin;
